<!-- resources/views/post_pupillages/create.blade.php -->
<x-layout>
    ...
    <a href="{{ url()->previous() }}" class="inline-flex items-center px-4 py-2 bg-gray-500 text-white font-semibold text-sm rounded-lg hover:bg-gray-700">
        ...
        <h1 class="text-3xl font-bold text-center mb-8 text-gray-800">Apply for Post Pupillage Program</h1>
        ...
        <form action="{{ route('postPupillages.store') }}" method="POST" class="space-y-6">
            @csrf
...
<div>
    ...
    @enderror
            ...
            <div>
                ...
                <input type="text" name="kra_pin" id="kra_pin" placeholder="KRA PIN"
                    value="{{ old('kra_pin') }}"
                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm"
                    required>
                @error('kra_pin')
            ...
            <div>
                ...
                <input type="text" name="nhif_card_number" id="nhif_card_number" placeholder="NHIF/SHIF Card No"
