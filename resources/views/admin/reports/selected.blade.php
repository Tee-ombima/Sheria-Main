<x-layout>
    ...
    <h1 class="text-3xl font-bold mb-6">Selected for Interview</h1>
    ...
    <a href="{{ route('export.csv', ['type' => 'selected', 'job_title' => $jobTitle]) }}" class="mt-4 inline-block bg-blue-500 text-white px-4 py-2 rounded">Export as CSV</a>

    <!-- Button to download PDF -->
    
    <a href="{{ route('export.pdf', ['type' => 'selected', 'job_title' => $jobTitle]) }}" class="mt-4 inline-block bg-red-500 text-white px-4 py-2 rounded">Download PDF</a>
    </x-card>
